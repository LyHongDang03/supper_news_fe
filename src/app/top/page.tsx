    ...
    <div className="bg-white min-h-screen">
      <main className="max-w-[1440px] mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold uppercase tracking-tight text-slate-800">TOP</h1>
            </div>
        ...
        <div className="flex items-center justify-center gap-2 pb-12">
          ...
          <button className="w-8 h-8 flex items-center justify-center rounded-sm bg-slate-100 text-slate-600 font-medium text-sm hover:bg-slate-200">4</button>
