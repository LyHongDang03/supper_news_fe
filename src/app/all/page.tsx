...
const HEADLINES = [
  ...
  "Giá vắng trong nước quay đầu giảm mạnh sau chuỗi ngày tăng",
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold uppercase tracking-tight text-slate-800">TẤT CẢ TIN TỨC</h1>
            </div>
          </div>

          <div className="w-full md:w-auto flex-grow max-w-md">
            <SearchBar placeholder="Tìm kiếm trong tất cả tin tức" />
          </div>
        </div>
